...
import (
	...
	samplecontrollerv1 "github.com/lincoco/sample-controller/pkg/apis/samplecontroller/v1"
	versioned "github.com/lincoco/sample-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/lincoco/sample-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/lincoco/sample-controller/pkg/generated/listers/samplecontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&samplecontrollerv1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollerv1.Foo{}, f.defaultInformer)
}
