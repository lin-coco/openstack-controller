...
import (
	...
	v1 "github.com/lincoco/sample-controller/pkg/apis/samplecontroller/v1"
	scheme "github.com/lincoco/sample-controller/pkg/generated/clientset/versioned/scheme"
...
type FooInterface interface {
	...
	UpdateStatus(ctx context.Context, foo *v1.Foo, opts metav1.UpdateOptions) (*v1.Foo, error)
...
func newFoos(c *SamplecontrollerV1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) UpdateStatus(ctx context.Context, foo *v1.Foo, opts metav1.UpdateOptions) (result *v1.Foo, err error) {
	result = &v1.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
